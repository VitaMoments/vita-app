  ...
  return (
    <>
      ...
      <section className={appStyles.sectionHighlight}>
        <h2 className={appStyles.title}>Wat is onze Health APK?</h2>
        <p className={appStyles.subtitle}>
      ...
      <section className={appStyles.section}>
        <h2 className={appStyles.title}>Waarom preventie?</h2>
        <p className={appStyles.subtitle}>
          Voorkomen is goedkoper dan genezen. Minder verzuim, meer energie op de
          werkvloer en een sterker werkgeversmerk.
        </p>
      </section>
    </>
  );
